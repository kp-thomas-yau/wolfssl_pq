...
typedef struct WOLFSSL_X509_LOOKUP {
...
enum {
    ...
    /* TOOD: [Nginx] wants the next 5 detected. */
...
enum { /* ssl Constants */
    ...
    SSL_SESS_CACHE_NO_INTERNAL_STORE  = 36,
    SSL_SESS_CACHE_NO_INTERNAL        = 37,
...
WOLFSSL_API int wolfSSL_X509_up_ref(WOLFSSL_X509 *x);
